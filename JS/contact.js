...
export function contact() {
    ...
    <div class="contactContainer">
        <div class="contactContainerText">
            ...
            <p>Interested in a commission, art piece, a chat with another fellow artist, or just want to say hello? I'm always open to discussing new projects, artistic opportunities, or experimental collaborations.</p>
        </div>
        <div class="contactFormContainer">
            <div class="socialLinks">
                <a class="socialButtons discordButton" aria-label="Discord">
